...
namespace TcgDatabase.API.Controllers
{
    /// <summary>
    /// Controller for managing TCG cards (currently supports Yu-Gi-Oh!)
    /// </summary>
    ...
    public class CardController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet]
        public async Task<ActionResult<IList<TcgDatabase.Domain.Card>>> Get()
        {
        ...
        [HttpPost]
        public async Task<ActionResult<TcgDatabase.Domain.Card>> Post([FromBody] AddCardRequest request)
        {
